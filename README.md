...
1. Добавлены дополнительные предфильтры в глобальный поиск.
2. Реализован вывод промтов популярных запросов и предыдущих запросов пользователя в глобальном поиске.
2. Добавлена возможность просматривать предварительные результаты выполнения запроса при вводе промта в глобальном поиске.
2. Реализована сортировка поисковой выдачи с расширенными настройками и фильтрами.
2. Реализован функционал для динамического и ручного управления рекомендуемым контентом на стартовой странице.
2. Обеспечено логирование действий пользователей и вызовов API для информационнной безопасности.
2. Добавлен новый раздел для управления трансформациями данных.
2. Карточки для описания трансформаций данных связаны с продуктами и активами, добавлены на линейдж.
2. Доработан контрол с выпадающим списком.
2. Добавлен расширенный поиск и фильтры в контрол дя взаимосвязывания карточек.
2. Добавлена расшифровка всплывающих ошибок при редактировании карточек.
2. Исправлена ошибка с отображением раздела администрирования для ролей.
