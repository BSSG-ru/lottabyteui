...
export const domains = createSlice({
  name: 'domains',
  initialState,
  reducers: {},
...
export const domainQueries = createSlice({
  name: 'domainQueries',
  initialState,
  reducers: {},
  extraReducers: (builder) => {
...
export const changePageAction = createAction<ChangePageActionPayload>(TYPES.CHANGE_PAGE);
export const changeSortAction = createAction<ChangeSortActionPayload>(TYPES.CHANGE_SORT);
export const changeCountAction = createAction<ChangeCountActionPayload>(TYPES.CHANGE_COUNT);
export const changeGlobalQueryAction = createAction<ChangeGlobalQueryActionPayload>(
  TYPES.CHANGE_GLOBAL_QUERY,
);
export const changeFiltersAction = createAction<ChangeFiltersActionPayload>(TYPES.CHANGE_FILTERS);
